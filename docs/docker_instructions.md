...
In this section you will try running a basic container called whalesay. Refer to Part A in the Readings below if you need a refresher on the content taught in the training.
...
We will now try running a container with [Samtools](https://www.htslib.org/) installed to convert a SAM file to a BAM file. Refer to the Part B in the Readings below if you need a refresher on the content taught in the training.
