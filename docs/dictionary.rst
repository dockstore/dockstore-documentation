...
entry
-----
    Shorthand for a :ref:`dict tool`, :ref:`dict workflow`, :ref:`dict notebook`, or service that has been registered on Dockstore.  
...
notebook
--------
    An interactive document, made up of "cells" containing code, text, and images, authored and executed in a browser-based programming environment. Project :ref:`dict Jupyter` popularized Python-based notebooks and maintains related specifications and software.  

Further reading: :doc:`/getting-started/getting-started-with-notebooks </getting-started/getting-started-with-notebooks>`  
...
topic
-----
    A short text description of an :ref:`dict entry`, :ref:`dict collection`, or :ref:`dict organization`. You can specify an entry's topic in :ref:`dict .dockstore.yml`.  
