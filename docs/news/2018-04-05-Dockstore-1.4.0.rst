...
-  see a
   ...
   https://github.com/ga4gh/dockstore/wiki/WIP-Checker-Workflow-Support-Tutorial
-  launch-with
...
-  user requests such as the ability to link to `unencoded
   workflows <https://github.com/ga4gh/dockstore/issues/1097>`__
...
-  `WIP <https://github.com/ga4gh/dockstore/issues/1058>`__ for
   displaying CWL visualizations using view.commonwl.org

See a full list of our changes on
`GitHub <https://github.com/ga4gh/dockstore/milestone/15>`__.
