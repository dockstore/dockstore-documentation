...
5. Implement the downloadFrom and uploadTo methods from
   `ProvisionInterface <https://github.com/dockstore/dockstore/blob/develop/dockstore-file-plugin-parent/src/main/java/io/dockstore/provision/ProvisionInterface.java>`__
...
6. We recommend using
   `ProgressPrinter <https://github.com/dockstore/dockstore/blob/develop/dockstore-file-plugin-parent/src/main/java/io/dockstore/provision/ProgressPrinter.java>`__
