...
The first step to migrating a workflow is the same as adding a new workflow via GitHub Apps: install our Dockstore GitHub App onto repositories in your personal account or
...
Once the GitHub app is installed on the correct repository, the next step is to create a .dockstore.yml file. We'll cover a very straightforward example
