...
The tool we will be using throughout this tutorial is `BAMStats <https://sourceforge.net/projects/bamstats/>`__. It is a tool for summarising Next Generation Sequencing alignments. It accepts a BAM file as input and produces a ZIP file containing an HTML report on the alignment.
